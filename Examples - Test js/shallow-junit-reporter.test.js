...
describe('JUnit reporter', function () {
    var outDir = 'out',
        outFile = outDir + '/appstart-report.xml';
    ...
    it('should correctly generate the junit report for a successful run', function (done) {
        ...
        exec(`node start.js run test/fixtures/run/single-get-request.json -r junit --reporter-junit-export ${outFile}`,
            function (code) {
    ...
    it('should correctly generate the junit report for a failed run', function (done) {
        // eslint-disable-next-line max-len
        exec(`node start.js run test/fixtures/run/single-request-failing.json -r junit --reporter-junit-export ${outFile}`,
            function (code) {
    ...
    it('should correctly produce the junit report for a run with TypeError', function (done) {
        // eslint-disable-next-line max-len
        exec(`node start.js run test/fixtures/run/appstart-report-test.json -r junit --reporter-junit-export ${outFile}`,
            function (code) {
                expect(code, 'should have exit code of 1').to.equal(1);
                fs.readFile(outFile, function (err, data) {
                    expect(err).to.not.be.ok;
    ...
    it('should correctly produce the JUnit report in a pre-existing directory', function (done) {
        // eslint-disable-next-line max-len
        exec('node start.js run test/fixtures/run/single-get-request.json -r junit --reporter-junit-export out',
            function (code) {
    ...
    it('should correctly generate the junit report for a run with nested requests', function (done) {
        // eslint-disable-next-line max-len
        exec(`node start.js run test/fixtures/run/nested-requests-report-test.json -r junit --reporter-junit-export ${outFile}`,
            function (code) {
                expect(code, 'should have exit code of 0').to.equal(0);
                fs.readFile(outFile, function (err, data) {
                    expect(err).to.not.be.ok;
    ...
    it('should correctly generate the junit report for a failed run with nested requests', function (done) {
        // eslint-disable-next-line max-len
        exec(`node start.js run test/fixtures/run/nested-requests-fail-report-test.json -r junit --reporter-junit-export ${outFile}`,
            function (code) {
